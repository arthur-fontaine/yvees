      ...
      <div className="h-screen p-10">
          ...
          <div>
              <p className="text-sm text-muted-foreground max-w-3xl">
                  ...
                  page de ce parcours, où vous pourrez modifier les champs
                  et ajouter des étapes. À la créationd'un parcours, les
                  étapes de début et de fin sont automatiquement créées.
              </p>
          </div>
